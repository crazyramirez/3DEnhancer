...
ENGLISH = {
    "Abrir visor": "Open viewer",
    "Abrir comparador antes y después": "Open before and after viewer",
    "Haz clic para comparar, ampliar y explorar la imagen.": "Click to compare, zoom, and explore the image.",
    "Cargando imágenes…": "Loading images…",
    "ANTES · ORIGINAL": "BEFORE · ORIGINAL",
    "DESPUÉS · RESULTADO": "AFTER · RESULT",
    "Comparador antes y después": "Before and after viewer",
    "ESTUDIO DE COMPARACIÓN": "COMPARISON STUDIO",
    "Cerrar · Esc": "Close · Esc",
    "Comparar": "Compare",
    "Antes": "Before",
    "Después": "After",
    "Ajustar": "Fit",
    "Ajustar la imagen al visor · 0": "Fit image to viewer · 0",
    "Ver al 100% · 1": "View at 100% · 1",
    "Acercar · +": "Zoom in · +",
    "Alejar · −": "Zoom out · −",
    "Centrar la comparación": "Center comparison",
    "Pantalla completa": "Full screen",
    "Salir de pantalla completa": "Exit full screen",
    "Alternar pantalla completa · F": "Toggle full screen · F",
    "Rueda para ampliar · Arrastra para desplazarte · Doble clic para alternar 100% y ajustar": "Scroll to zoom · Drag to pan · Double-click to toggle 100% and fit",
    "Deslizador antes y después": "Before and after slider",
    "Arrastra para comparar; usa las flechas para ajustar con precisión.": "Drag to compare; use the arrow keys for precise adjustments.",
    "No se pudo abrir la imagen original.": "Could not open the original image.",
    "No se pudo abrir el resultado. Puedes explorar el original.": "Could not open the result. You can explore the original.",
    "Resultado pendiente. Puedes explorar el original; la comparación aparecerá cuando esté listo.": "Result pending. Explore the original; the comparison will appear when it is ready.",
    "Idioma": "Language",
    "Sistema": "System",
